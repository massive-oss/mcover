MCover is a macro based cross-platform code coverage tool that runs on all main Haxe targets including js, flash, neko, cpp and php.
...
The code coverage tool is designed to integrate with existing unit testing frameworks (like munit) to provide detailed metrics on test coverage.
...
MCover is fully integrated with MUnit's rich HTML print client (MUnit 0.9.2.0 or higher)
...
### Step 1. Enable the MCover print client

This should already be generated in your TestMain class unless you have a very old version of munit.
