...
Main.completionHandler = function(percent) {
	Main.completed = true;
	haxe.Log.trace("Coverage report complete: " + percent + "%",{ fileName : "Main.hx", lineNumber : 46, className : "Main", methodName : "completionHandler"});
}
Main.prototype = {
	__class__: Main
}
...
m.cover.coverage.CoverageLoggerImpl.prototype = {
	...
	,reportCurrentTest: function(skipClients) {
		if(skipClients == null) skipClients = false;
		if(this.currentTest == null) throw new m.cover.coverage.CoverageException("No test specified to report on.",null,{ fileName : "CoverageLogger.hx", lineNumber : 145, className : "m.cover.coverage.CoverageLoggerImpl", methodName : "reportCurrentTest"});
	...
	,initializeCoverage: function(resourceName) {
		...
		if(serializedData == null) throw new m.cover.coverage.CoverageException("No generated coverage data found in haxe Resource '" + resourceName + "'",null,{ fileName : "CoverageLogger.hx", lineNumber : 203, className : "m.cover.coverage.CoverageLoggerImpl", methodName : "initializeCoverage"});
		try {
			this.coverage = haxe.Unserializer.run(serializedData);
		} catch( e ) {
			throw new m.cover.coverage.CoverageException("Unable to unserialize coverage data in " + resourceName,e,{ fileName : "CoverageLogger.hx", lineNumber : 210, className : "m.cover.coverage.CoverageLoggerImpl", methodName : "initializeCoverage"});
		}
	}
