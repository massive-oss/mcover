...
m.cover.coverage.client.PrintClient.prototype.report = function(coverage) {
	...
	this.printReport();
	var timer = m.cover.coverage.util.Timer.delay($closure(this,"reportComplete"),10);
}
...
if(!m.cover.coverage.util) m.cover.coverage.util = {}
m.cover.coverage.util.Timer = function(time_ms) {
	if( time_ms === $_ ) return;
	this.run = $closure(this,"defaultRun");
	this.id = m.cover.coverage.util.Timer.arr.length;
	m.cover.coverage.util.Timer.arr[this.id] = this;
	this.timerId = window.setInterval("m.cover.coverage.util.Timer.arr[" + this.id + "].run();",time_ms);
}
m.cover.coverage.util.Timer.__name__ = ["m","cover","coverage","util","Timer"];
m.cover.coverage.util.Timer.delay = function(f,time_ms) {
	var t = new m.cover.coverage.util.Timer(time_ms);
	t.run = function() {
		t.stop();
		f();
	};
...
m.cover.coverage.util.Timer.stamp = function() {
	return Date.now().getTime() / 1000;
}
m.cover.coverage.util.Timer.inlineStamp = function() {
	return Date.now().getTime() / 1000;
}
m.cover.coverage.util.Timer.prototype.run = null;
m.cover.coverage.util.Timer.prototype.id = null;
m.cover.coverage.util.Timer.prototype.timerId = null;
m.cover.coverage.util.Timer.prototype.defaultRun = function() {
}
m.cover.coverage.util.Timer.prototype.stop = function() {
	if(this.id == null) return;
	window.clearInterval(this.timerId);
	m.cover.coverage.util.Timer.arr[this.id] = null;
	if(this.id > 100 && this.id == m.cover.coverage.util.Timer.arr.length - 1) {
		var p = this.id - 1;
		while(p >= 0 && m.cover.coverage.util.Timer.arr[p] == null) p--;
		m.cover.coverage.util.Timer.arr = m.cover.coverage.util.Timer.arr.slice(0,p + 1);
	}
	this.id = null;
}
m.cover.coverage.util.Timer.prototype.__class__ = m.cover.coverage.util.Timer;
...
haxe.Resource.content = [{ name : "MCoverData", data : "s16344:"}];
...
m.cover.coverage.util.Timer.__meta__ = { obj : { IgnoreLogging : null}, statics : { inlineStamp : { IgnoreCover : null}}, fields : { defaultRun : { IgnoreCover : null}}};
m.cover.coverage.util.Timer.arr = [];
