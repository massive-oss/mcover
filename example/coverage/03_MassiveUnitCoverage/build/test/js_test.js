...
example.AccountTest = function(p) {
}
example.AccountTest.__name__ = ["example","AccountTest"];
example.AccountTest.prototype.instance = null;
example.AccountTest.prototype.beforeClass = function() {
}
example.AccountTest.prototype.afterClass = function() {
}
example.AccountTest.prototype.setup = function() {
}
example.AccountTest.prototype.tearDown = function() {
}
example.AccountTest.prototype.shouldBeEmptyAtConstructor = function() {
...
example.AccountTest.prototype.shouldAddValueToTotal = function() {
	this.instance = new example.Account();
...
example.AccountTest.prototype.__class__ = example.AccountTest;
...
example.CalculatorTest = function(p) {
}
example.CalculatorTest.__name__ = ["example","CalculatorTest"];
example.CalculatorTest.prototype.instance = null;
example.CalculatorTest.prototype.beforeClass = function() {
}
example.CalculatorTest.prototype.afterClass = function() {
}
example.CalculatorTest.prototype.setup = function() {
}
example.CalculatorTest.prototype.tearDown = function() {
}
example.CalculatorTest.prototype.shouldAddValues = function() {
	var a = 1;
	var b = 10;
...
example.CalculatorTest.prototype.shouldReturn10 = function() {
	var a = 10;
	var b = 1;
...
example.CalculatorTest.prototype.__class__ = example.CalculatorTest;
...
m.cover.coverage.munit.client.MCoverPrintClient = function(munitClient,mcoverClient,mcoverLogger) {
	if( munitClient === $_ ) return;
...
m.cover.coverage.munit.client.MCoverPrintClient.prototype.id = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.completionHandler = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.get_completeHandler = function() {
	return this.completionHandler;
}
m.cover.coverage.munit.client.MCoverPrintClient.prototype.set_completeHandler = function(value) {
	return this.completionHandler = value;
}
m.cover.coverage.munit.client.MCoverPrintClient.prototype.includeMissingBlocks = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.includeExecutionFrequency = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.includeClassAndPackageBreakdowns = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.client = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.mcoverLogger = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.mcoverClient = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.coveredClasses = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.currentCoveredClass = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.classPercentage = null;
m.cover.coverage.munit.client.MCoverPrintClient.prototype.addPass = function(result) {
	this.client.addPass(result);
}
m.cover.coverage.munit.client.MCoverPrintClient.prototype.addFail = function(result) {
	this.client.addFail(result);
}
m.cover.coverage.munit.client.MCoverPrintClient.prototype.addError = function(result) {
	this.client.addError(result);
}
m.cover.coverage.munit.client.MCoverPrintClient.prototype.addIgnore = function(result) {
	this.client.addIgnore(result);
}
m.cover.coverage.munit.client.MCoverPrintClient.prototype.initializeMCoverLogger = function() {
	try {
...
m.cover.coverage.munit.client.MCoverPrintClient.prototype.init = function() {
	this.includeMissingBlocks = true;
	this.includeExecutionFrequency = true;
...
m.cover.coverage.munit.client.MCoverPrintClient.prototype.setCurrentTestClass = function(className) {
...
m.cover.coverage.munit.client.MCoverPrintClient.prototype.reportFinalStatistics = function(testCount,passCount,failCount,errorCount,ignoreCount,time) {
	this.updateFinalCoverageReport();
	var result = this.client.reportFinalStatistics(testCount,passCount,failCount,errorCount,ignoreCount,time);
	if(this.get_completeHandler() != null) (this.get_completeHandler())(this);
	return result;
}
m.cover.coverage.munit.client.MCoverPrintClient.prototype.updateTestClassCoverage = function() {
...
m.cover.coverage.munit.client.MCoverPrintClient.prototype.updateFinalCoverageReport = function() {
...
m.cover.coverage.munit.client.MCoverPrintClient.prototype.createOutstandingCoverageResults = function() {
...
m.cover.coverage.munit.client.MCoverPrintClient.prototype.createCoverageResultForClass = function(cls) {
...
m.cover.coverage.munit.client.MCoverPrintClient.prototype.__class__ = m.cover.coverage.munit.client.MCoverPrintClient;
...
haxe.Resource.content = [{ name : "MCoverData", data : "s2826:"}];
{
	var d = Date;
	d.now = function() {
		return new Date();
