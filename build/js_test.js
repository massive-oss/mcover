...
massive.mcover.MCoverRunner = function(p) {
	if( p === $_ ) return;
	massive.mcover.MCoverRunner.log("13|src|massive.mcover|MCoverRunner|1516|1523|src/massive/mcover/MCoverRunner.hx:69: characters 2-9");
	this.reset();
}
massive.mcover.MCoverRunner.__name__ = ["massive","mcover","MCoverRunner"];
massive.mcover.MCoverRunner.addClient = function(client) {
	massive.mcover.MCoverRunner.log("14|src|massive.mcover|MCoverRunner|977|1001|src/massive/mcover/MCoverRunner.hx:43: characters 2-26");
	massive.mcover.MCoverRunner.clientQueue.push(client);
}
massive.mcover.MCoverRunner.report = function() {
	massive.mcover.MCoverRunner.log("15|src|massive.mcover|MCoverRunner|741|761|src/massive/mcover/MCoverRunner.hx:33: characters 2-22");
...
massive.mcover.MCoverRunner.prototype.addEntryToHashes = function(entry) {
	massive.mcover.MCoverRunner.log("2|src|massive.mcover|MCoverRunner|4140|4181|src/massive/mcover/MCoverRunner.hx:211: characters 2-43");
	...
	if(!this.packages.exists(packageKey)) {
		massive.mcover.MCoverRunner.log("0|src|massive.mcover|MCoverRunner|4305|4370|src/massive/mcover/MCoverRunner.hx:216: characters 3-68");
	...
	if(!this.classes.exists(classKey)) {
		massive.mcover.MCoverRunner.log("1|src|massive.mcover|MCoverRunner|4585|4645|src/massive/mcover/MCoverRunner.hx:226: characters 3-63");
...
massive.mcover.MCoverRunner.prototype.parseEntries = function() {
	massive.mcover.MCoverRunner.log("3|src|massive.mcover|MCoverRunner|3808|3853|src/massive/mcover/MCoverRunner.hx:194: characters 2-47");
...
massive.mcover.MCoverRunner.prototype.clientCompletionHandler = function(client) {
	massive.mcover.MCoverRunner.log("6|src|massive.mcover|MCoverRunner|3541|3773|src/massive/mcover/MCoverRunner.hx:181: lines 181-189");
	if(++this.clientCompleteCount == this.clients.length) {
		massive.mcover.MCoverRunner.log("5|src|massive.mcover|MCoverRunner|3593|3769|src/massive/mcover/MCoverRunner.hx:183: lines 183-188");
		if(this.completionHandler != null) {
			massive.mcover.MCoverRunner.log("4|src|massive.mcover|MCoverRunner|3633|3665|src/massive/mcover/MCoverRunner.hx:185: characters 4-36");
...
massive.mcover.MCoverRunner.prototype.reportResults = function() {
	massive.mcover.MCoverRunner.log("8|src|massive.mcover|MCoverRunner|3196|3219|src/massive/mcover/MCoverRunner.hx:164: characters 2-25");
	this.clientCompleteCount = 0;
	if(this.clients.length == 0) {
		massive.mcover.MCoverRunner.log("7|src|massive.mcover|MCoverRunner|3255|3286|src/massive/mcover/MCoverRunner.hx:168: characters 3-34");
...
massive.mcover.MCoverRunner.prototype.logEntry = function(value) {
	massive.mcover.MCoverRunner.log("10|src|massive.mcover|MCoverRunner|2899|2935|src/massive/mcover/MCoverRunner.hx:146: characters 2-38");
	...
	if(!entry.get_result()) {
		massive.mcover.MCoverRunner.log("9|src|massive.mcover|MCoverRunner|3072|3082|src/massive/mcover/MCoverRunner.hx:154: characters 3-13");
		this.count += 1;
	}
	entry.count += 1;
	var _g = 0, _g1 = this.clients;
...
massive.mcover.MCoverRunner.prototype.init = function() {
	massive.mcover.MCoverRunner.log("11|src|massive.mcover|MCoverRunner|2406|2424|src/massive/mcover/MCoverRunner.hx:121: characters 2-20");
...
massive.mcover.MCoverRunner.prototype.reset = function() {
	massive.mcover.MCoverRunner.log("12|src|massive.mcover|MCoverRunner|1779|1798|src/massive/mcover/MCoverRunner.hx:79: characters 2-21");
...
massive.mcover.MCoverRunner.prototype.initialized = null;
...
haxe.Resource.content = [{ name : "MCover", data : "s2124:"}];
{
